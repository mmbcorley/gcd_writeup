...
Trunk movements are also a plausible  utterance-initial gesture, allowing us to avoid any confounds that might arise from overlaps between the on-screen presentations of the gesture, and of the visual targets referred to later in each target utterance. % might need to rephrase
