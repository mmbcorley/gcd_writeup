...
\oldtodo[inline]{JK we need to work out why we did this. why did we do it? also, how are we going to analyse ratings? and in relation to what?}
...
\oldtodo[inline]{JK need a paragraph here. also maybe just need rewriting whole discussion. we didn't really provide any evidence that it's speaker-modelling, but now i'm saying that it's not heuristic because decision takes time.. ??}.
