...
participants were marginally less likely to click on the referent following videos showing a trunk movement than following videos showing no cue (\resultsLog{-0.56}{0.32}{=0.08}).
...
Analysis conducted over the 800~ms period from referent onset showed a main effect of time (\resultsLM{2.40}{0.69}{=3.65}), indicating that as this time window went on, participants became increasingly likely to fixate the referent over the distractor.
Importantly, there was no interaction of visual cue with time, suggesting that participants' increasing tendency to fixate the referent was not influenced by whether the video showed the speaker producing a trunk movement or sitting motionless.

                              Estimate Std. Error t value
(Intercept)                    -0.3833     0.3877  -0.988
vid_typeTrunk Movement         -0.1784     0.5666  -0.315
time_s                          2.2311     0.9238   2.415
vid_typeTrunk Movement:time_s   0.3524     1.2686   0.278
...
Over the course of the window, participants showed an increasing likelihood of having moved more toward the referent than the distractor (as indicated by a main effect of time \resultsLM{0.73}{0.32}{=2.31}). 
As in the analysis of eye-movements, whether videos showed trunk movements or no cue was not found to effect participants' mouse-movements over time. %JK this is the interaction. 
...
Analysis of filler trials was conducted on 797 trials (3 trials were excluded from analysis due to no mouse click on either object)
Mixed effects logistic regression with ??? 
%fixed effect
%random effects (by-item random effects of cue were not possible due to these videos not being counterbalanced across referents)
...
Results show that,  ----- clicks on the referent following videos showing no cue (\resultsLog{}{}{}) and fewer clicks on the referent following videos showing adaptor gestures (\resultsLog{}{}{}).
...
Visual inspection of the time-course of eye-movements (see Figure \ref{fig:v1_eye2}) suggests an apparent association between adaptor gesturing and deception, with a greater proportion of fixations to the distractor than the referent emerging later on (approximately 1000~ms) following these trials.
Similarly, the time-course of mouse-movements (see Figure \ref{fig:v1_mouse2}) appears to show the greatest attenuation of the bias towards the referent following videos of adaptor gestures.
...
Post-hoc analysis of filler trials, however, suggested that other visual cues used as fillers (specifically adaptor gestures) influenced participants' decisions to click on either object.
Furthermore, visual inspection of the time-course of eye- and mouse-movements in filler trials indicated that videos of adaptor gesturing may result in the greatest attenuation of the bias to fixate on and move towards the referent. 
Taken together with the analysis of final judgements of deception (via objects clicked) in filler trials, we suggest that adaptor gestures, and not trunk movements, may elicit more judgements of deception. 
...
Comparatively, despite the cues used in filler trials showing movement in a smaller area of the video (or no movement at all), their proximity in time to critical noun may explain why they, but not trunk movements, appeared to elicit more judgements of deception. %JK both, or just adaptors?
...
Alternatively, the strength of specific cues to deception may be dependent upon what other cues the speaker tends to produce, with judgements of veracity focussing on whichever cue is most salient for a given speaker/situation.%JK is this reasonable?
...
However, additional analyses of filler trials in which videos showed the speaker producing either an adaptor gesture or sitting in a different posture indicate that in particular adaptor gesturing appeared to be associated with judgements of dishonesty.
From a practical viewpoint, the time-course of participants' eye- and mouse-movements in Experiment~1 suggest that the visual world paradigm may be compatible with a range of video stimuli: Even when viewing videos in which movements co-occurred with speech (e.g. adaptor gestures), visualisation of proportions of fixations indicate that the video did not prevent fixations on the objects in the display increasing in the early stages of reference comprehension.
...
To directly investigate whether the association between adaptor gesturing and perceived dishonesty is detectable at the early stages of reference comprehension, we conducted Experiment~2, in which participants saw videos of a speaker either producing an adaptor gesture, or sitting motionless, and there were no filler trials.
...
%filler trials, more cues, diluted effect?
...
%but not all cues. maybe need more reliable more cue ocntext-
