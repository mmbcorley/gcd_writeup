...
We show that speaker's nonverbal behaviour can have a rapid and direct influence on addressees' pragmatic judgements, supporting the idea that communication is fundamentally multimodal.
}


\begin{document}

\shorttitle{Such gesture, very lie, wow}
\maketitle
\linenumbers
\noindent
...
Focussing on more traditional gestures (movements which visually represent ideational content), a small number of studies have indicated that representational content in gestures is integrated into language comprehension along a similar time course to the processing of linguistic information \citep[See e.g.][]{Ozyurek2007, Kelly2004}. 
To our knowledge, however, no studies have explored the time course of how visual information is integrated into the pragmatic interpretation of the speaker's utterance.

The influence of gestures on pragmatic comprehension has received very little attention beyond the finding that pointing gestures are associated with a greater likelihood of listeners interpreting an utterance as an indirect request \citep[See][]{Kelly1999, Kelly2001}, and this research has relied on post-facto measures of pragmatic comprehension such as clicks to objects or responses to follow-up questions.
...
Recent work by \citet{Loy2017} has highlighted that the associations between manner of spoken delivery and deceit are evident at the early stages of comprehension.
