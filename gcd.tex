...
Adhering to a rule-of-thumb association may be feasible for spoken cues, and evidence shows that some effects of speech interruptions on comprehension do not discern between a spoken \spex{um} and an artificial tone \citep{Corley2011}.
Co-speech movements, however, are substantially more varied than speech interruptions, and can be attributed to many things aside from the planning processes involved in speech production (e.g. they can function as a substitute for spoken content).%JK better e.g

Thus any rule-of-thumb heuristic between visual information and disfluency must strike a balance between parsimony and 
