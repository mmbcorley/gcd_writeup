...
Consistent with previous research in deception judgments and beliefs about cues to deception, participants linked dishonesty with an increase in movement. % Jia: can we cite someone here? i know we've cited this point somewhere in the backgroundy bit but it's quite distant by now and readers probably don't still have it in mind
