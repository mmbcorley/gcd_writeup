...
For adaptor gestures, the movements were allowed to overlap with speech in order to make the audio and video more believable, with the duration of overlap determined individually for each video (Mean = 1370ms, SD = 410ms).
...
Utterances presented alongside any movement or different posture weakened this tendency, but only the presence of adaptor gesturing resulted in significantly more judgments of deception than truthfulness (indicated by more clicks to the distractor over the referent).

The influence of the visual channel was also evident in participants' early stages of utterance processing. 
Across videos both with and without a cue, participants showed an initial tendency to fixate and move the mouse toward the referent over distractor; however, videos of different postures and adaptor gestures resulted in a reduction of this tendency.
...
This could simply be a result of the inclusion of videos in the experimental stimuli detracting from participants' fixations to the two objects.
This would also explain the differences in the early window (0 to 1100~ms) between the types of cue: The reduction in the referent-bias may be a result of the video being more salient in both the different posture and the adaptor gesture conditions, and not evidence of am emerging bias towards interpreting the utterances as dishonest. 
...
Experiment 2, a simplified version of the experiment in which we focused on one type of cue --- adaptor gesturing.
