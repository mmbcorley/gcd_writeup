...
One such pragmatic interpretation is the judgement of whether or not a speaker is being deceitful.
...
While much research has investigated which types of nonverbal behavioural cues listeners associate with deception, how these cues are incorporated into judgements of deception remains unclear.
More generally, the cognitive mechanisms underpinning how visual information is integrated with speech is relatively understudied.
Focussing on more traditional gestures (movements which visually represent ideational content), a small number of studies have indicated that the semantic \todo{JK for want of a better word} meaning in gestures is integrated into language comprehension along a similar time-course to the processing of linguistic information \citep[See e.g.][]{Ozyurek2007, Kelly2004}. 
To our knowledge, however, no studies have explored whether listeners' ability to rapidly integrate visual information extends to nonverbal behaviours which may influence the pragmatic interpretation of the speaker's utterance.
Understanding how listeners associate nonverbal cues with deception offers insight into the wider question of how speakers' nonverbal behaviour influences the pragmatic interpretation of language. 

One suggestion of how behavioural cues are linked with perceived deception is that their judgements might follow simple and straightforward rules-of-thumb, relying on heuristically associating certain cues with deception \citep{DePaulo1982}.
The heuristics may be predicated on lay beliefs about deception, or on introspection as a speaker rather than experience as a listener \citep[See e.g.][]{Vrij1996}.
...
Nonverbal behaviours, however, are substantially more varied than speech interruptions: For a listener, they may serve as both potential markers of metacognitive states and planning processes, and as an alternative modality in which the speaker conveys semantic information \citep[See, e.g.][]{Ekman1969,Mcneill1992}. 
Any rule-of-thumb linking visual information to deception would have to be refined enough to discriminate types of nonverbal behaviours, or risk potentially over-attributing any cue as a sign of deceit.
...
Participants would have to make links between specific non-linguistic behaviour and metacognition, which would in turn be linked to a judgement of deception.
...
In thhowing the speaker producing an adaptor gesture.
e current study, we investigate how deception judgements based on a speaker's nonverbal behavioural cues unfold during on-line language comprehension in a multi-modal setting.
...
Alternatively, the inclusion of additional nonverbal behaviours in filler trials weakened the association between trunk movements and deception which has been found in previously \citep[e.g][]{Vrij1996a, Zuckerman1981}.
...
Relative to videos showing no cue to deception, participants' tendency to fixate and move towards the referent (over the distractor) more as time increased was attenuated following videos showing the speaker producing an adaptor gesture.
...
%% jk: agreed. however, i'm not sure quite how to interpret what we've done with regards to that question. it might be worth taking out altogether? Martin, what are your thoughts?
